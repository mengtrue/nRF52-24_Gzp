...
static void ble_haptic_evt_handler(ble_haptic_t * p_haptic, ble_haptic_evt_t * p_evt)
{
    switch (p_evt->type)
    {
			  case BLE_HAPTIC_EVT_NOTIFICATION_ENABLED:
            NRF_LOG_INFO("Enable BLE Haptic service\r\n");
            /*NRF_POWER->GPREGRET = 1;
            NVIC_SystemReset();*/
            break;
        case BLE_HAPTIC_EVT_NOTIFICATION_DISABLED:
            NRF_LOG_INFO("Disable BLE Haptic service\r\n");
            break;
        case BLE_HAPTIC_EVT_RUMBLE_SEND:
            NRF_LOG_INFO("BLE Haptic send rumble message\r\n");
            break;
        default:
            NRF_LOG_INFO("Unknown event from ble_haptic\r\n");
            break;
    }
}
